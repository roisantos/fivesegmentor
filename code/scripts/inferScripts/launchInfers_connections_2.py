...
models_config = {
    "RoiNetResSkip": {
        ...
        "model_path": r"/mnt/netapp2/Store_uni/home/usc/ci/avs/tfg/tfg/fork-roi/fivesegmentor/code/scripts/inferScripts/inputs/RoiNetResSkip_result_2025-03-17_19-46-44/RoiNetResSkip_Dice/model_best.pth"
    },
    "RoiNetConcatPlus": {
        "config": {
            "type": "RoiNetConcatPlus",
            "ch_in": 3,
            "ch_out": 1,
            "cls_init_block": "ResidualBlock",
            "cls_conv_block": "ResidualBlock"
        },
        "model_path": r"/mnt/netapp2/Store_uni/home/usc/ci/avs/tfg/tfg/fork-roi/fivesegmentor/code/scripts/inferScripts/inputs/RoiNetConcatPlus_result_2025-03-17_19-47-49/RoiNetConcatPlus_Dice/model_best.pth"
    },
    "RoiNetMultiSkip": {
        "config": {
            "type": "RoiNetMultiSkip",
            "ch_in": 3,
            "ch_out": 1,
            "cls_init_block": "ResidualBlock",
            "cls_conv_block": "ResidualBlock"
        },
        "model_path": r"/mnt/netapp2/Store_uni/home/usc/ci/avs/tfg/tfg/fork-roi/fivesegmentor/code/scripts/inferScripts/inputs/RoiNetMultiSkip_result_2025-03-17_19-49-02/RoiNetMultiSkip_Dice/model_best.pth"
    }
}
